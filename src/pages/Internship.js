...
const Internship = () => {
  return (
    ...
    <div className="banner career-banner-img">
        <div className="banner-title">Internship Program
</div>
        <p className="banner-details">Discover how you can apply your talent and skills to harness powerful change with our career-building internship program.

</p>
        <button className="btn">Contact us Today</button>
      </div>
      <div className="top-container margi" >
          <div className="top-container-text" style={{width:'50%'}}>
            <div className="heading">We groom talent and prepare them for best jobs!
</div>
            <p>
          ...
          <div className="top-container-img" style={{width:'50%'}}>
